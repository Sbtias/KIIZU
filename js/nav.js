...
async function openSettings(){
  ...
  if(premiumSection){
    ...
    try{
      ...
      premiumSection.hidden=!active || data?.plan!=="premium";
      if(active && premiumCancel){
        ...
        if(data.auto_renew===false && premiumStatus) premiumStatus.textContent="Premium seguirá activo hasta "+new Date(data.expires_at).toLocaleDateString("es-PR")+". Essential no usa renovación automática.";
      }
